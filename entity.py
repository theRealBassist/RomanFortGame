...
class Entity(pygame.sprite.Sprite):
    ...
    def moveTowards(self, pos):
        ...
        if self.getLOS(self.target) : self.direction = self.getTargetDirection(pos)
    ...
    def getFollowTarget(self):
        ...
        for entity in self.group:
            if self.getTargetDistance(entity.rect.center) > 100: continue
